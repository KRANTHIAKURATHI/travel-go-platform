...
export default function PackageDetailsPage() {
  ...
  if (!pkg) return <div className="p-8 text-center text-gray-500 dark:text-gray-400">Package not found</div>
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-800 flex items-center justify-center px-4">
        <div className="max-w-md w-full bg-white dark:bg-gray-900 rounded-3xl shadow-xl p-8 text-center animate-fade-up">
          ...
          <div className="bg-gray-50 dark:bg-gray-800 rounded-2xl p-4 text-left space-y-2 mb-6 text-sm">
            ...
            <div className="flex justify-between"><span className="text-gray-500 dark:text-gray-400">Package</span><span className="font-semibold">{pkg.title}</span></div>
            <div className="flex justify-between"><span className="text-gray-500 dark:text-gray-400">Participants</span><span>{bookingForm.num_participants}</span></div>
            <div className="flex justify-between"><span className="text-gray-500 dark:text-gray-400">Amount Paid</span><span className="font-bold text-green-600">₹{total.toLocaleString()}</span></div>
          </div>
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-800">
      ...
      <div className="max-w-5xl mx-auto px-6 py-8 grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          {/* Quick info */}
          <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 p-5 grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
            {[
              ...
              <div key={label}>
                ...
                <div className="font-semibold text-gray-900 dark:text-gray-100 text-sm capitalize">{val}</div>
          ...
          <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 p-5">
            <h2 className="font-semibold text-gray-900 dark:text-gray-100 mb-3">About This Package</h2>
            <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed">{pkg.description}</p>
          </div>

          {/* Inclusions/Exclusions */}
          <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 p-5 grid grid-cols-1 md:grid-cols-2 gap-5">
            <div>
              <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-3 flex items-center gap-2"><CheckCircle size={16} className="text-green-500" />Inclusions</h3>
            ...
            <div>
              <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-3 flex items-center gap-2"><X size={16} className="text-red-400" />Exclusions</h3>
              <ul className="space-y-2">
          ...
          <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 p-5 sticky top-24">
            ...
            {!showForm ? (
              ...
              <form onSubmit={handleBook} className="space-y-3">
                ...
                <button type="button" onClick={() => setShowForm(false)} className="w-full text-sm text-gray-400 hover:text-gray-600 dark:text-gray-300">Cancel</button>
              </form>
            )}
          </div>
        </div>
